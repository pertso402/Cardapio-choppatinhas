...
window.CHOPP = {
  ...
  // "Os mais pedidos" — ranking REAL copiado do Anota.ai da casa em 2026-09-23
  // (seção "Os mais pedidos" de pedido.anota.ai/loja/choppatinhas-delivery).
  // Nome base do produto no nosso banco. Vendas reais do Supabase desempatam e
  // completam a lista com itens que já venderam 3+ vezes pelo cardápio/WhatsApp.
  MAIS_PEDIDOS: [
    'Frango Frito Especial',
    'Porção De Batata Frita',
    'Porção De Polenta Frita',
    'Combo Frango Frito Especial C/ Arroz E Salada',
    'Combo Frango C/Batata',
    'Guaraná Antarctica',
  ],

  // Vídeo de destaque: o topo mostra o produto que tiver vídeo (campo video_url,
  // enviado pelo admin). Se mais de um tiver, vale o que estiver com ⭐ destaque.
  // Sem nenhum vídeo, mostra a foto do produto nº1 com zoom lento.
  VIDEO_MAX_MB: 50,
};
